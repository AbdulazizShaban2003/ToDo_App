...
import 'package:todo_app/features/states/cubit/task_cubit.dart';

class EndTime extends StatelessWidget {
  const EndTime({super.key, required this.theme});
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            controller: taskCubit.endTimeController,
            readOnly: true,
            decoration: InputDecoration(
              suffixIcon: InkWell(
                onTap: () => taskCubit.selectTime(context, false),
